...
export const Route = createFileRoute("/experiences/$slug")({
  ...
  head: ({ loaderData }) => ({
    meta: [
      ...
      { name: "description", content: loaderData?.experience.overview ?? "경험 상세" },
    ],
  }),
  notFoundComponent: () => (
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-t border-border">
        <div className="mx-auto max-w-5xl px-6 py-10 flex items-center justify-between gap-6">
          <Link to="/experiences/$slug" params={{ slug: prev.slug }} className="group text-left">
          ...
          <Link to="/experiences/$slug" params={{ slug: next.slug }} className="group text-right">
