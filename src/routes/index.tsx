      ...
      <div className="mx-auto w-full max-w-[1600px] px-5 py-12 md:py-16">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-10 md:ml-8 lg:ml-14">
          ...
          <div>
            ...
            <p className="mt-5 font-serif text-sm sm:text-base md:text-lg font-bold text-foreground leading-relaxed break-keep">
              자신감과 소신을 잃지 않으면서도,
              <br />
              <span className="block">타인과 화합할 줄 아는 사람으로 성장했습니다.</span>
            </p>
            <Divider />
